...
**Status:** Target architecture designed; **partially implemented**.  
**Source of truth (prose):** `docs/spx/SPX-Slayer-Playbook-Design-v1.docx`  
...
|-------|-----------|--------|-------|
| Named playbooks PB-01…03 | Yes | Yes (shadow + ARM UI) | Registry + matcher |
| Named playbooks PB-04…12 | Yes (catalog) | No | Intentionally deferred |
