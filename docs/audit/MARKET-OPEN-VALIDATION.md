...
### 210. `underlyingExcursionCoaching` was called unconditionally in every swing coaching pass but was structurally guaranteed to always return null — and its one live-computable remainder was fully redundant with already-shipped content — chore/swing-remove-dead-underlying-excursion-coaching — 2026-09-15
