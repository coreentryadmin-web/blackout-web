...
### 150. Ask Largo swing play-brief's per-contract `$` formatter disagreed with itself — same number, two different cents, same API response — fix/swing-playbrief-option-usd-rounding-mismatch — 2026-09-12
