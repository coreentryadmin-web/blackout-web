...
### 0ad. UW in-process REST cache + Polygon index overlay future guards — merged #3771
...
### 0ac. Stock SSE change_pct ws-bar authority gate — merged #3769
...
### 0ab. Vector GEX walls spot constraint — merged #3764
