...
### 222. Swing horizons board: 2dp premium rounding disagreed with the API's own `livePnlPct` for penny-priced Banger-origin contracts — fix/swing-horizons-penny-premium-rounding-precision — 2026-09-15
