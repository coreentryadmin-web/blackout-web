...
### 270. Ask Largo swing brief never surfaced how far the underlying itself has run favorable/adverse since entry, despite it being computed and pinned on every management tick — fix/swing-underlying-excursion — 2026-09-18
