...
Our engine scans **12,400+ contracts daily** and grades every setup **A–F**. Only about **3% survive** the screen. You don't get forty alerts a day to sift through — you get the handful that actually passed. In a world of information overload, ruthless filtering is the feature.

## 3. We log every trade publicly

This is the one most tools won't do. Every setup BlackOut flags is logged publicly, with full transparency — **including the ones that don't work.** No hindsight edits, no quietly deleted losers, no cherry-picked wins in a screenshot. If you want to know how the calls actually played out, [the record is right there](/track-record). That accountability is rare in this space, and it's on purpose.
