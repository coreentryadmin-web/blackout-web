        ...
        <div className="sf-grid">
          ...
          <div className="sf-col">
            ...
            <div className="sf-socials">
              <a href="https://x.com/BlackOutTrade" target="_blank" rel="noopener noreferrer" className="sf-social" aria-label="Follow @BlackOutTrade on X">
                <svg viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
              </a>
              <a href="https://www.instagram.com/blackouttrades" target="_blank" rel="noopener noreferrer" className="sf-social" aria-label="@blackouttrades on Instagram">
              ...
              <a href="https://discord.gg/r8AEcnDCv" target="_blank" rel="noopener noreferrer" className="sf-social" aria-label="Join the BlackOut Discord">
          ...
          {/* Col 2: Desk */}
          <div className="sf-col">
            <div className="sf-col-title">Desk</div>
          ...
          {/* Col 3: Legal */}
          <div className="sf-col">
            <div className="sf-col-title">Legal</div>
          ...
          {/* Col 4: Community */}
          <div className="sf-col">
            <div className="sf-col-title">Community</div>
            <a href="https://discord.gg/r8AEcnDCv" target="_blank" rel="noopener noreferrer">Discord</a>
            <a href="https://x.com/BlackOutTrade" target="_blank" rel="noopener noreferrer">X</a>
            <a href="https://www.instagram.com/blackouttrades" target="_blank" rel="noopener noreferrer">Instagram</a>
          </div>
        </div>

        {/* Risk disclaimer */}
        <div className="sf-risk">
          <p>Risk Disclosure: Options and equities trading involve substantial risk and are not suitable for every investor. BlackOut provides educational tools and market analysis only and does not provide investment advice. Past performance is not indicative of future results.</p>
        </div>

        <div className="sf-bottom">
          <div className="sf-copy">&copy; 2026 BlackOut Trading. All Rights Reserved.</div>
        </div>
      </footer>
