...
const ROADMAP: Stage[] = [
  ...
  { n: 4, name: "Unified per-alert audit trail", status: "IN PROGRESS", blurb: "alert_audit_log schema shipped (additive, zero consumers). 0DTE + Night Hawk write-paths are the next two steps, each its own PR." },
