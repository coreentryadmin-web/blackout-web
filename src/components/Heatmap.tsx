...
import { EmptyState, Skeleton, Tabs, TabList, Tab, TabPanels, TabPanel } from "@/components/ui";
  ...
  return (
    <div className="desk-layout space-y-5">
      ...
      <Tabs defaultValue="gex">
        <TabList aria-label="Heatmap view">
          <Tab value="gex">GEX</Tab>
          <Tab value="sectors">Sectors</Tab>
        </TabList>

        <TabPanels>
          {/* Primary GEX view — dealer gamma matrix (strike × expiry). */}
          <TabPanel value="gex">
            <GexHeatmap ticker="SPY" />
          </TabPanel>

          {/* Existing sector thermal + movers, preserved intact. */}
