...
// preset, adding IWM to the grid silently gave a Largo tool 33% more upstream work on a path already
// trimmed once for ~120s timeouts. This assertion is the tripwire for that coupling returning.
