...
test("wallCountForTimeframe: preset timeframes map to the specified shown-counts", () => {
  // Restored 2026-09-05 to pre-#2341 ladder (member bead-structure screenshots). Shared book
  // denominator sizing means more rows no longer flatten every level to the same weight.
