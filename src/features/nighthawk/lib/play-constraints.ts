 ...
 *  Aligned with play-levels.ts ENTRY_RR target (0.75) — was 0.5, which let publish admit
 *  worse books than level construction aims for (2026-07-29 Legacy precision). */
export const MIN_RR_RATIO = 0.75;
