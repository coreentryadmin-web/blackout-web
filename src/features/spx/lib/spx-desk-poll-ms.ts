...
/** Full desk rebuild (walls, levels, enrichment) — default 2s (was 5s; server cache SWR absorbs load). */
export const SPX_FULL_DESK_POLL_MS = pollMs("NEXT_PUBLIC_SPX_FULL_DESK_POLL_MS", 2_000);
...
/** Matrix off-hours / AH — default 5s (lighter traffic). */
