...
export const metadata: Metadata = publicPageMetadata(
  ...
  "How BlackOut compares to typical options-analytics platforms: real-time streaming data vs delayed snapshots, graded track record vs cherry-picked alerts, one desk vs scattered tabs and Discords.",
  "/vs/others"
);
...
const ROWS: Row[] = [
  { feature: "Data freshness", blackout: "Real-time streaming where the underlying feed supports it", others: "Delayed snapshots, manual refresh" },
  ...
  { feature: "Where the tools live", blackout: `${MARKETING_PRODUCTS.length} engines, one screen, one membership`, others: "Scattered across 5 tabs and 3 Discords" },
