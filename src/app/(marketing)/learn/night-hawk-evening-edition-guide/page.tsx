...
const article = getArticle("night-hawk-evening-edition-guide")!;
...
export default function NightHawkEveningEdition() {
  return (
    <>
      <ArticleJsonLd
      ...
      <Breadcrumbs items={[
        ...
        { name: "Night Hawk Evening Edition", href: article.path },
      ]} />
