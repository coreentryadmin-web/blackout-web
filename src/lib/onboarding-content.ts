...
export const ONBOARDING_STEPS: readonly OnboardingStep[] = [
  ...
  },
  {
    ...
    body: "See which sectors are catching or losing money in real time. Rotation tells you where strength is hiding before it shows up in the headlines.",
    href: "/heatmap",
    cta: "Open Heatmaps",
  },
  {
  ...
  },
  {
    ...
    body: "Swing scanner and playbook for multi-day setups. Run hunt modes to score the universe against bias, DTE, and SPX alignment when the regular session is closed.",
    href: "/nighthawk",
    cta: "Open Night Hawk",
  },
  {
