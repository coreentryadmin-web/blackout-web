 ...
 *  so G-12 demands a HIGHER confluence floor here. Exported so a backtest can sweep the boundary. */
...
export type ZeroDteConfluence = {
  ...
  timing_ok: boolean;
  /** Inside the measured-negative early window [10:00, 10:45) ET — G-12 raises the confluence floor. */
