...
const NARRATIVE_COVERED_TITLES = new Set([
  // Book context is NOT collapsed — narrative no longer carries bookContextCoaching
  // (#4116 removed the duplicate); collapsing here silenced concentration entirely (main red).
  "Lane rank",
  "Levels on chart",
  "GEX posture",
  "Wall dynamics",
