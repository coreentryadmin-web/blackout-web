...
export const CHUNK_ERROR_PATTERN_SOURCE =
  "ChunkLoadError|Loading chunk [0-9]+ failed|Loading CSS chunk|Failed to fetch dynamically imported module|error loading dynamically imported module|Refused to execute script|Refused to apply style|Importing a module script failed|UnrecognizedActionError|Server Action [^ ]+ was not found";
