...
export function computeCalibration(
  ...
  return {
    ...
    // Night Hawk/0DTE/market-context-tool-calling passes too — this pure function
...
/** Task #161 — direct analogue of formatSpxToolCallCalibration/
 *  formatZeroDteToolCallCalibration above, for market_context's tool-calling
 *  cohort — the last of BIE's 4 deterministic router intents to get one. */
