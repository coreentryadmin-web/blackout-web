...
const ECOSYSTEM_CONTEXT_FIELD_DESCRIPTIONS: Record<Exclude<keyof EcosystemContext, "ticker">, string> = {
  ...
  spx_desk_convergence: "SPX desk convergence — Vector vs Slayer alignment verdict, summarized vector/slayer layers, live gate_rules, and matrix_ui (GEX/VEX lens availability; active lens toggle is client-only). The exact same object Largo's get_spx_desk_convergence tool returns. SPX/SPXW only.",
