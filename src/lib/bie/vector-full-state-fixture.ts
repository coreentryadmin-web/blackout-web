...
export const VECTOR_FULL_STATE_FIXTURE: VectorFullState = {
  ...
  ladder: {
    ...
    rows: [
      { strike: 7650, gex: 1_100_000_000, side: "call", magnitude: 0.26, isKing: false, migration: null },
      { strike: 7600, gex: 4_200_000_000, side: "call", magnitude: 1, isKing: true, migration: null },
      { strike: 7500, gex: -3_800_000_000, side: "put", magnitude: 0.9, isKing: true, migration: null },
      { strike: 7450, gex: -900_000_000, side: "put", magnitude: 0.21, isKing: false, migration: null },
    ],
  },
