...
export const ROUTES: RouteDefinition[] = [
  ...
  { path: "/api/market/heatmap", methods: ["GET"], area: "market", class: "read", description: "Sector performance and market movers." },
  { path: "/api/market/gex-heatmap", methods: ["GET"], area: "market", class: "read", description: "GEX heatmap surface for a ticker (dealer positioning matrix)." },
  { path: "/api/market/gex-heatmap/explain", methods: ["GET"], area: "market", class: "mutation", description: "LLM-powered narrative summary of GEX heatmap — cached per ticker (~180s), calls Claude on miss." },
