...
export const CRON_JOBS: CronJobDefinition[] = [
  {
    ...
    schedule_label: "~Every 2 min (RTH 9:30 AM–4:00 PM ET)",
    stale_after_min: 15,
  ...
  },
  {
    ...
    schedule_label: "~Every 5 min (7AM–4:15PM ET engine window)",
    stale_after_min: 20,
    weekdays_only: true,
    market_hours_only: true,
  ...
  },
  {
    ...
    schedule_label: "~Every 60s (RTH 9:30 AM–4:00 PM ET)",
    stale_after_min: 10,
    weekdays_only: true,
    market_hours_only: true,
  ...
  },
  {
    ...
    schedule_label: "~Every 30s (RTH 9:30 AM–4:00 PM ET)",
    stale_after_min: 10,
    weekdays_only: true,
    market_hours_only: true,
  ...
  },
  {
    ...
    schedule_label: "~Every 5 min (RTH 9:30 AM–4:00 PM ET)",
    stale_after_min: 20,
    weekdays_only: true,
    market_hours_only: true,
  ...
  },
  {
    ...
    schedule_label: "~Every 10 min (RTH 9:30 AM–4:00 PM ET)",
    stale_after_min: 25,
    weekdays_only: true,
    market_hours_only: true,
    description:
  ...
  },
  {
    ...
    schedule_label: "~Every 30 min (RTH 9:30 AM–4:00 PM ET)",
    stale_after_min: 90,
    weekdays_only: true,
    market_hours_only: true,
    description:
