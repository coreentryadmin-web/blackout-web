 ...
 * trace back here. The catalog has since caught up: 138 of 138 today, and `registry.test.ts` holds
 ...
 * As of this writing 138 catalogued capabilities declare an entitlement (`premium` or `admin`);
...
export type GuardedRunnerOptions = {
  viewer: ToolGuardViewer;
  /** The real executor. Injected so this module stays free of the 138-tool dependency graph. */
