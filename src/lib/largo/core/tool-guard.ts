 ...
 * trace back here. The catalog has since caught up: 134 of 134 today, and `registry.test.ts` holds
...
export type GuardedRunnerOptions = {
  viewer: ToolGuardViewer;
  /** The real executor. Injected so this module stays free of the 134-tool dependency graph. */
