...
export const LARGO_CAPABILITIES: readonly LargoCapability[] = [
  ...
  {
    id: "nighthawk.gate_rules",
    product: "NIGHT_HAWK",
    tool: "get_gate_rules",
    answers: "What are the gate rules — what does each gate actually test?",
    temporal: "live_only",
    freshness: "historical",
    entities: [],
    entitlement: "premium",
    keywords: ["gate", "rule", "why blocked", "criteria", "threshold"],
    caveat: "Live only. The rules as they stand in code NOW. It cannot say what a gate tested at an earlier date.",
  },
  {
    id: "platform.uw_raw",
    product: "PLATFORM",
