...
- **Catalysts / earnings** — get_meridian_timeline (the desk's ranked macro/earnings/OpEx/FDA calendar), get_meridian_event (one event's full detail), get_meridian_peer_cohort (sector peer cohort + reaction history for one earnings print), get_catalysts, get_earnings, get_earnings_calendar, get_economic_calendar
