...
// Largo product contract C1: ET stamp + ET session date from the SHARED helpers
// (bar-session-date.ts, #2418), never a local Intl call — one definition of "what session
// is it" across every lane.
