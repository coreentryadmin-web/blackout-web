// Behavioral coverage for recheckSseUserEntitlement — source-scan tests prove CALL sites;
// this file proves the revalidation logic under Q41 scenarios (tier drop, tool revoke, outage).
