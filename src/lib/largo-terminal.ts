...
async function prepareLargoTurn(
  ...
  //
  // Hints only. All 138 tools stay in the request, so this can never make an answer impossible
  ...
  // nothing and hides nothing; the model may ignore it, and the full 138-tool surface is still in
