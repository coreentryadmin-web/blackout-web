...
async function auditCrossTool() {
  ...
  try {
    ...
    // Bootstrap pulse and gex-positioning refresh on independent lanes; ~1.5 pt skew is normal.
    if (Number.isFinite(bootSpot) && Number.isFinite(gexSpot) && Math.abs(bootSpot - gexSpot) > 1.5) {
