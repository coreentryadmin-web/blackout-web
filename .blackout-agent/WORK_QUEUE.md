...
|----|-----|-------|-------|--------|
| BO-P1-0005 | P1 | Review Claude PRs when verify green | cursor | DONE (0 open PRs swept) |
| BO-P1-0004 | P1 | Post-deploy 0DTE replay (G-18/G-19 counterfactual) | cursor | DONE (replay GREEN 6/6, 66.7% WR) |
