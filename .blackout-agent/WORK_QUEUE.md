...
|----|-----|-------|-------|--------|
| BO-P1-0004 | P1 | Post-deploy 0DTE replay (G-18/G-19 counterfactual) | cursor | DONE (6/6 replayed, 0 bars_failed) |
| BO-P1-0007 | P1 | PR webhook triage + peer review dispatch | cursor | DONE (#3439 merged) |
| BO-P1-0005 | P1 | Review Claude PRs when verify green | cursor | DONE (#3444, #3445 merged) |
