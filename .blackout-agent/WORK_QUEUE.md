...
|----|-----|-------|-------|--------|
| BO-P1-0005 | P1 | Review Claude PRs when verify green | cursor | IN_PROGRESS |
| BO-P1-0004 | P1 | Post-deploy 0DTE replay (G-18/G-19 counterfactual) | cursor | IN_PROGRESS (#3452 merged; #3463 fix pending Claude merge) |
