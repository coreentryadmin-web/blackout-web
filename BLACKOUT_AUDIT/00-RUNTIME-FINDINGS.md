...
- **Business impact:** During a ~30s `api.massive.com` connectivity blip (13:19 UTC) the SPX play (a flagship
...
- **Technical impact (observed):**
  ...
  [market/spx/play] TypeError: fetch failed
    [cause]: ConnectTimeoutError: Connect Timeout Error (attempted address: api.massive.com:443, timeout: 10000ms)  code: UND_ERR_CONNECT_TIMEOUT
